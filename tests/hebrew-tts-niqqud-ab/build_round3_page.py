...
SECTIONS = [
    ...
    ("T",  "תגים — [laughter] / [sigh]", "המבחן: התג מתעלם (לא נורא), נאמר בקול (אסור!), או באמת נשמע צחוק/אנחה (מעולה)? בחר B רק אם התג באמת עבד."),
    ("P",  "פיסוק כרגש", "אותו משפט, פיסוק שונה. המבחן: האם !! או ... או ניסוח עם ברירה באמת משנים את ההגשה?"),
    ("E",  "ניסוח רגשי", "מה שהנחיה בפרומפט תייצר בפועל. המבחן: איזו גרסה נשמעת יותר אנושית ופחות רובוטית?"),
]
