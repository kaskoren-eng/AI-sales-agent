...
const envSchema = z.object({
  ...
  // `VOICE_TTS_PROVIDER=deepdub` this flag does nothing however it is set, on purpose.
  //
  // MEASURED, not assumed: DeepDub READS THE TAG ALOUD — Soniox hears "break time 00:56" inside
  // the sentence, +2.2 to +2.7s of markup spoken at the caller. known-issues §18 has the table.
